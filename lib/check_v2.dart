...
Future<NatMappingBehavior> _testMappingPhase1() async {
  try {
...
Future<NatMappingBehavior> _testMappingPhase2(StunMessage message1) async {
  try {
...
Future<NatMappingBehavior> _testMappingPhase3(StunMessage message1, StunMessage message2) async {
  try {
...
Future<NatFilteringBehavior> _testFilteringPhase1() async {
  try {
    ...
    createBindingStunMessage.attributes.add(rfc5780.ChangeRequest(flagChangeIp: true, flagChangePort: true));
...
Future<NatFilteringBehavior> _testFilteringPhase2() async {
  try {
    ...
    var createBindingStunMessage = _stunClient.createBindingStunMessage();
    createBindingStunMessage.attributes.add(rfc5780.ChangeRequest(flagChangeIp: false, flagChangePort: true));
    StunMessage message = await _stunClient.sendAndAwait(createBindingStunMessage);
    _stunClient.disconnect();
